...
switch(
  "passL",
  (&"""
  -o {distDir / "collab_cooking_replay.js"}
  ...
  -s EXPORTED_FUNCTIONS=_main,_malloc,_free,_cc_load_replay,_cc_frame,_cc_input,_cc_packet_ptr,_cc_packet_len,_cc_error_ptr,_cc_error_len,_cc_stage_ptr,_cc_stage_len
  """).replace("\n", " ")
)
